...
4. Images and Masks gathered in Tensors and Data Loaders
   (these Data Loaders are separated by Training, Validation, and Test Images)

#### Training

* During this stage, the model undergoes [NUMBER] epochs of training.
...
The following commands were used to setup the environment and install packages/libraries
requried by the model.
